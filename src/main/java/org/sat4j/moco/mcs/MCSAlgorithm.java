...
public abstract class MCSAlgorithm {
     ...
     * {@link #extract(PBSolver, IVecInt, IVecInt)}.
     */
     ...
     * {@link #extract(PBSolver, IVecInt, IVecInt)}, i.e., an MCS was found or the hard formula was proven
     * unsatisfiable.
     */
    private boolean is_solved = false;
    
    /**
     * Boolean used to store if an MCS was found on the last call to {@link #extract(PBSolver, IVecInt, IVecInt)}.
     */
    ...
    /**
     * If an MCS was found on the last successful call to {@link #extract(PBSolver, IVecInt, IVecInt)}, retrieves that
     * MCS.
     * @return The MCS.
     */
    ...
    /**
     * If an MCS was found on the last successful call to {@link #extract(PBSolver, IVecInt, IVecInt)}, retrieves the
     * corresponding MSS.
     * @return The MSS.
     */
     ...
     * To be used by {@link #extract(PBSolver, IVecInt, IVecInt)} whenever a model is found by the algorithm.
    ...
    /**
     * If a model was produced on the last call to {@link #extract(PBSolver, IVecInt, IVecInt)}, retrieves the value
     ...
     * To be used by {@link #extract(PBSolver, IVecInt, IVecInt)} when an MCS is found.
     * @param mcs The MCS.
     ...
     * To be used by {@link #extract(PBSolver, IVecInt, IVecInt)} when the formula is proven unsatisfiable.
     */
     ...
     * To be used by {@link #extract(PBSolver, IVecInt, IVecInt)} when something prevents the formula from being
     * solved (e.g. timeout).
     */
     ...
     */
    void extract(PBSolver s, IVecInt lits, IVecInt asms) { run(s, lits, asms); }
     ...
     * @param lits The soft literals.
     */
    protected abstract void run(PBSolver s, IVecInt lits, IVecInt asms);
